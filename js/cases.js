...
var homepageLink = function() {
  ...
  switch (hash) {
    case 'service': changeTab(hash); break;
    case 'business': changeTab(hash); break;
    case 'finance': changeTab(hash); break;
    case 'education': changeTab(hash); break;
    case 'hardware': changeTab(hash); break;
  }
};
